...
for each_row in apps_data[1:]:
    if each_row[11] != 'Games':
        non_games_ratings.append(float(each_row[7]))
...
for app in apps_data[1:]:
    if float(app[4]) > 9.0:
        apps_more_9.append(float(app[7]))
    else:
        apps_less_9.append(float(app[7]))
...
for app in apps_data[1:]:
    ...
    if price == 0.0:
        ...
        price_label = 'very expensive'
    
    app.append(price_label)
