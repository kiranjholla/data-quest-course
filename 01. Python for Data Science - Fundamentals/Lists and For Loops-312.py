...
fb_rating_data = [row_1[APP_NAME], row_1[USER_COUNT], row_1[RATING]]
insta_rating_data = [row_2[APP_NAME], row_2[USER_COUNT], row_2[RATING]]
pandora_rating_data = [row_5[APP_NAME], row_5[USER_COUNT], row_5[RATING]]
...
for each_row in apps_data[1:]:
    all_ratings.append(float(each_row[7]))
