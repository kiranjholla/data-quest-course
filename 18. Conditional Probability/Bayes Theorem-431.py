...
p_delay = p_airbus * p_delay_given_airbus + p_boeing * p_delay_given_boeing
...
p_airbus_delay = p_airbus * p_delay_given_airbus / (p_airbus * p_delay_given_airbus + p_boeing * p_delay_given_boeing)
...
p_secret = p_secret_given_non_spam * (1 - p_spam) + p_secret_given_spam * p_spam

# Bayes Theorm [ p_b_given_a = (p_b * p_a_given_b)/p_a ]
