...
tech_outside_usa = f500.loc[(f500['country'] != 'USA') & (f500['sector'] == 'Technology')].head(5)

## 10. Sorting Values ##

top_japanese_employer = f500.loc[f500['country'] == 'Japan'].sort_values('employees', ascending=False).iloc[0]['company']
...
for country in countries:
    top_employer_by_country[country] = f500.loc[f500['country'] == country].sort_values('employees', ascending=False).iloc[0]['company']
...
for sector in f500['sector'].unique():
    top_roa_by_sector[sector] = f500.loc[f500['sector'] == sector].sort_values('roa', ascending=False).iloc[0]['company']