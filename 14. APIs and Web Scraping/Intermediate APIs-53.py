...
status = requests.patch("https://api.github.com/repos/VikParuchuri/learning-about-apis", json={"description": "Learning about requests!", "name": "learning-about-apis"}, headers=headers).status_code
